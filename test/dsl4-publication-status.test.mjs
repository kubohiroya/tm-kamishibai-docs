...
import {dsl4PublicationStatus} from '../docs/config.mjs';
...
test('shows the same release boundary on the 4.0 top and primary documents', () => {
  ...
  for (const source of [
    ...
    assert.match(source, /保証しません|確認してください|保守作業を含みます/u);
  }
});
