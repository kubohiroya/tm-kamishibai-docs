...
source実装とtestを追加しています。追加機能はfeature flagが既定OFFのため、4.0.0-rc.6の現行公開APIには含まれません。
...
- [DSL 4.0ランタイム ブロックリファレンス](../turbowarp-programmer-guides/dsl-4.0-runtime-block-reference.md): 4.0.0-rc.6で現在公開されているblockとStage変数
