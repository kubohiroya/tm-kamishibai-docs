...
正式リリース後の入門チュートリアル「紙芝居を作る」は、検証済みstarterを一つ変更して、最初の作品を
完成させるための短い実習です。本書の全構文や全actionを順に読む前提ではありません。

| 資料                               | 対象読者                                       | 前提                                      | 完了するとできること                                                                | 詳細の委譲先                       |
| ---------------------------------- | ---------------------------------------------- | ----------------------------------------- | ----------------------------------------------------------------------------------- | ---------------------------------- |
| 入門チュートリアル「紙芝居を作る」 | 初めてDSL 4.0を書く方                          | 大人向け概要、固定starter                 | YAMLの変更、preview、診断修正、検証、自己完結SB3の再生                              | 本書の必要な節、Schemaリファレンス |
| 本書「台本作成ガイド」             | 作品の機能を広げる作者、教材作成者、授業設計者 | 4.0の概要、または入門チュートリアルの完了 | project構成、Source Graph、全action、入力、診断、配布前確認を必要な範囲で調べられる | Schemaリファレンス、開発者向け文書 |
| Schemaリファレンス                 | fieldやactionの型・必須性を検索する方          | 参照したい項目が分かっていること          | 固定Schemaの制約を確認できる                                                        | 入門手順は扱わない                 |

チュートリアルがまだ公開されていない間は、最短経路を「大人向け概要 → 本書の記法 → 最小台本 →
Projectのfileを配置する → Web Preview → 診断と安全停止 → 作成時のチェックリスト」とします。チュートリアル
...
| 補足 | 必要なときだけSource Graph、全action、詳細な制約 | 作品の機能を広げられる         |
