...
標準実行環境: `4.0.0-rc.6`（公開プレリリース）\
このチュートリアルの公開サンプル: `4.0.0-rc.6`（公開成果物）\
...
「Web版を開く」を押します。作品の説明で、この公開サンプルの対象バージョンが`4.0.0-rc.6`であることと、カメラを
使うことを確認してから開きます。
...
表示されます。これは公開サンプル自身の版表示です。`Version 4.0.0-rc.6`を確認し、右上の「閉じる」を押すと
作品が始まります。
...
_この画像は旧rc.3画面の固定証跡です。現在の公開Web版ではVersion 4.0.0-rc.6と利用条件を確認し、右上の「閉じる」を押します。_
...
成功表示のあと、見本の姿を残したまま「できた！ 頭を守れたね。揺れがおさまるまで、そのまま
待とう。」という達成メッセージが5秒間表示されます。メニューへ戻る前に、できたことと次の行動を
確認します。
...
画面のセリフや案内に従い、最後の場面まで進めます。達成メッセージが消えるとメニューへ戻ります。
もう一度遊ぶ場合は、メニューの「もう一度」を選びます。

<!-- screenshot:P-07 -->

![頭を守る見本と、できたことおよび揺れがおさまるまで待つことを伝える達成メッセージ](../images/tutorials/dsl4/play/tutorial-play-07-finished.png)

_メニューへ戻る前に、できたことと次の行動を伝えます。画像は説明用fixtureです。_
