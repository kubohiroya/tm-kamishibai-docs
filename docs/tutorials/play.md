...
標準実行環境: `4.0.0-rc.7`（公開プレリリース）\
このチュートリアルの公開サンプル: `4.0.0-rc.7`（公開成果物）\
...
「Web版を開く」を押します。作品の説明で、この公開サンプルの対象バージョンが`4.0.0-rc.7`であることと、カメラを
使うことを確認してから開きます。
...
表示されます。これは公開サンプル自身の版表示です。`Version 4.0.0-rc.7`を確認し、右上の「閉じる」を押すと
作品が始まります。
...
_この画像は旧rc.3画面の固定証跡です。現在の公開Web版ではVersion 4.0.0-rc.7と利用条件を確認し、右上の「閉じる」を押します。_
