...
この手順では`4.0.0-rc.8`の非埋め込みStandard SB3と、同じrelease入力から生成したスターターを使用します。
...
2. 「ファイル」から`kamishibai-4.0.0-rc.8.sb3`を読み込む
3. 緑の旗を押す
...
- [ ] rc.8基準の公開スターターと`4.0.0-rc.8`の非埋め込みStandard SB3を用意した
