...
| `executive-summary-adult-4.0`「仕組みを詳しく知る」                                                                                          | projectが何を経て上演されるか                              | projectからruntimeまでの概念図がある                                   | 概要では概念図だけを維持。固定実装の画面記録は不要         | P1     | semantic HTML、本文注記                                     | #101 review。実装証跡は開発者向け資料へ限定    |
